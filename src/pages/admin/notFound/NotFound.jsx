  ...
  return (
    <div className='h-screen flex justify-center items-center'>
        <div className='flex justify-center items-center flex-col '>
            ...
            <p className="text-[24px] font-fontMedium font-semibold text-black">Go to the Dashboard Home By <Link className="text-[#A357C4] hover:underline" to={'/dashboard/'}>Click Here</Link></p>
        </div>
    </div>
  )
}
