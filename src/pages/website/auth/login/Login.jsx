...
const Login = () => {
    return (
        <div className="py-[40px] xl:py-[90px] lg:py-[60px] md:py-[40px]  flex items-center justify-center">
            <div className="bg-white p-8 msm:mx-[20px] xxxsm:mx-[10px] rounded-lg shadow-lg w-[600px] h-[600px] xl:w-[600px] xl:h-[600px] lg:h-[520px] md:h-[490px] md:w-[500px] sm:w-[500px] sm:h-[490px] msm:w-[420px] msm:h-[420px] xxxsm:w-[420px] xxxsm:h-[420px]">
                ...
                <div className="text-center mt-9 lg:mt-5 msm:mt-2 xxxsm:mt-2">
                    <p className="xl:text-[22px] lg:text-[22px]  md:text-[17px] msm:text-[16px] sm:text-[17px] xxxsm:text-[16px] text-gray-600">
                        Don't have an account? <Link to={"/catholicgrapevine/signup"} className="text-[#A357C4] font-fontMedium font-bold hover:underline">Join Now</Link>
                    </p>
                </div>
            </div>
        </div>
